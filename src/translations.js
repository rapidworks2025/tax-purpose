export const translations = {
  en: {
    ...
    services: {
      ...
      description: "Professional tax consulting tailored to your sustainable and social impact goals. I focus on specialized tax consulting, offering tax compliance through partners.",
      cards: {
        social: {
          ...
          features: [
            ...
            "Reinvestments in social projects, donations, and sponsorships"
          ]
        },
        sustainability: {
        ...
        international: {
          ...
          description: "Tax consulting for cross-border, inbound, and outbound projects with sustainability and social focus, especially in the Belgium and Netherlands border region.",
          features: [
            "Choice of legal form for new or restructured companies",
            "Tax support for transactions and contract assessments",
            "Financing advice from a tax perspective"
          ]
        }
      },
    ...
    footer: {
      description: "Expert tax consulting for social entrepreneurship and sustainable projects",
  ...
  de: {
    nav: {
      ...
      partners: "Partner",
      contact: "Kontakt",
      schedule: "Beratungstermin"
    },
    hero: {
      tag: "Internationale Steuerberatung",
      title: {
        line1: "Förderung sozialer &",
        line2: "nachhaltiger Unternehmen",
        line3: "durch professionelle Steuerberatung"
      },
      description: "30 Jahre internationale Steuererfahrung kombiniert mit der Leidenschaft für soziales Unternehmertum und Nachhaltigkeit, um bedeutsame gesellschaftliche Veränderungen zu bewirken.",
      cta: {
        schedule: "Beratungstermin vereinbaren",
        learn: "Mehr erfahren"
      }
    },
    services: {
      tag: "Meine Expertise",
      title: "Umfassende Steuerberatung",
      description: "Professionelle Steuerberatung für Ihre nachhaltigen und sozialen Ziele. Ich fokussiere mich auf steuerliche Spezialberatung, die steuerliche Compliance biete ich über Kooperationspartner an.",
      cards: {
        social: {
          ...
          features: [
            ...
            "Reinvestitionen in soziale Projekte sowie Spenden und Sponsoring"
          ]
        },
        sustainability: {
        ...
        international: {
          title: "Internationale Steuern",
          description: "Steuerberatung zu grenzüberschreitenden, inbound- und outbound Projekten mit Nachhaltigkeits- und Gesellschaftsbezug, Grenzregion Belgien und Niederlande mit Blick auf die Welt.",
          features: [
            "Rechtsformwahl im Rahmen der Gründung bzw. der Rechtformänderung / Restrukturierung von bestehenden Unternehmen",
            "steuerliche Unterstützung bei Transaktionen, steuerliche Beurteilung von Verträgen",
            "Finanzierungsberatung aus steuerlicher Sicht"
          ]
        }
      },
    ...
    footer: {
      description: "Professionelle Steuerberatung für soziales Unternehmertum und nachhaltige Projekte",
